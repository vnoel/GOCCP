...
echo ${COMPILO} $NAME.tmp.f90 calendar.f90 output.f90 signal.f90 subgrid.f90 vertical_mean.f90 $F90FLAGS1 -o ${NAME}.e

${COMPILO} $NAME.tmp.f90 $home/calendar.f90 output.f90 signal.f90 subgrid.f90 vertical_mean.f90 $F90FLAGS1 -o ${NAME}.e
