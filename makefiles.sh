...
echo ${COMPILO} $NAME.tmp.f90 output.f90 surface.f90 vertical_mean.f90 calendar.f90 $F90FLAGS1 -o ${NAME}.e
${COMPILO} $NAME.tmp.f90 output.f90 surface.f90 vertical_mean.f90 calendar.f90 $F90FLAGS1 -o ${NAME}.e
